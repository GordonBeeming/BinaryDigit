...
Sys._ScriptLoaderTask.prototype = {
    ...
    execute: function() { if (this._ensureReadyStateLoaded())this._executeInternal(); },
    ...
    _useReadyState: function() { return Sys.Browser.agent === Sys.Browser.InternetExplorer && (Sys.Browser.version < 9 || (document.documentMode || 0) < 9); }
};
Sys._ScriptLoaderTask.registerClass("Sys._ScriptLoaderTask", null, Sys.IDisposable);
Sys._ScriptLoaderTask._clearScript = function(a) { if (!Sys.Debug.isDebug && a.parentNode)a.parentNode.removeChild(a); };
Type.registerNamespace("Sys.Net");
