...
Sys.Services._ProfileService.prototype = {
    ...
    _path: "",
    _timeout: 0,
    get_defaultLoadCompletedCallback: function() { return this._defaultLoadCompletedCallback; },
    ...
    _flattenProperties: function(a, i, j) {
        var b = {}, e, d, g = 0;
        if (a && a.length === 0)return { value: b, count: 0 };
        for (var c in i) {
            e = i[c];
            d = j ? j + "." + c : c;
    ...
    _onLoadComplete: function(a, e, g) {
        ...
        for (var b in c)this.properties[b] = c[b];
...
Sys.Services.ProfileGroup = function(a) { if (a)for (var b in a)this[b] = a[b]; };
...
Sys.Services._AuthenticationService.prototype = {
    ...
    get_defaultLoginCompletedCallback: function() { return this._defaultLoginCompletedCallback; },
    ...
    get_isLoggedIn: function() { return this._authenticated; },
    get_path: function() { return this._path || ""; },
    ...
    _setAuthenticated: function(a) { this._authenticated = a; }
};
...
Sys.Services._RoleService.prototype = {
    ...
    set_defaultLoadCompletedCallback: function(a) { this._defaultLoadCompletedCallback = a; },
    get_path: function() { return this._path || ""; },
    get_roles: function() { return Array.clone(this._roles); },
