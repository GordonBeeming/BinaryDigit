...
Sys.WebForms.BeginRequestEventArgs.prototype = { get_postBackElement: function() { return this._postBackElement; }, get_request: function() { return this._request; }, get_updatePanelsToUpdate: function() { return this._updatePanelsToUpdate ? Array.clone(this._updatePanelsToUpdate) : []; } };
...
Sys.WebForms.EndRequestEventArgs.prototype = { get_dataItems: function() { return this._dataItems; }, get_error: function() { return this._error; }, get_errorHandled: function() { return this._errorHandled; }, set_errorHandled: function(a) { this._errorHandled = a; }, get_response: function() { return this._response; } };
...
Sys.WebForms.InitializeRequestEventArgs.prototype = {
    get_postBackElement: function() { return this._postBackElement; },
    get_request: function() { return this._request; },
    get_updatePanelsToUpdate: function() { return this._updatePanelsToUpdate ? Array.clone(this._updatePanelsToUpdate) : []; },
...
Sys._ScriptLoader._errorScriptLoadFailed = function(b) {
    ...
    var d = "Sys.ScriptLoadFailedException: " + String.format(a, b), c = Error.create(d, { name: "Sys.ScriptLoadFailedException", "scriptUrl": b });
    c.popStackFrame();
    return c;
};
...
Sys.WebForms.PageRequestManager.prototype = {
    ...
    get_isInAsyncPostBack: function() { return this._request !== null; },
    ...
    _createPostBackSettings: function(d, a, c, b) { return { async: d, asyncTarget: c, panelsToUpdate: a, sourceElement: b }; },
    ...
    _getScrollPosition: function() {
        ...
        if (a && (this._validPosition(a.scrollLeft) || this._validPosition(a.scrollTop)))return { x: a.scrollLeft, y: a.scrollTop };
        else {
            a = document.body;
            if (a && (this._validPosition(a.scrollLeft) || this._validPosition(a.scrollTop)))return { x: a.scrollLeft, y: a.scrollTop };
    ...
    _onWindowUnload: function() { this.dispose(); },
    ...
    _pageLoadedInitialLoad: function() { this._pageLoaded(true, null); },
        ...
        for (var l = 0, G = k.length; l < G; l++) {
            ...
            case "pageRedirect":
                ...
                if (Sys.Browser.agent === Sys.Browser.InternetExplorer) {
                    ...
                    function B(a) { a.cancelBubble = true; }
    ...
    _processUpdatePanelArrays: function(e, q, r, f) {
        ...
        return { updatePanelIDs: d, updatePanelClientIDs: c, updatePanelHasChildrenAsTriggers: b, asyncPostBackControlIDs: n, asyncPostBackControlClientIDs: l, postBackControlIDs: o, postBackControlClientIDs: m };
    },
    ...
    _uniqueIDToClientID: function(a) { return a.replace(/\$/g, "_"); },
    _updateControls: function(d, a, c, b, e) { this._commitControls(this._processUpdatePanelArrays(d, a, c, e), b); },
    ...
    _validPosition: function(a) { return typeof a !== "undefined" && a !== null && a !== 0; }
};
...
Sys.UI._UpdateProgress.prototype = {
    get_displayAfter: function() { return this._displayAfter; },
    set_displayAfter: function(a) { this._displayAfter = a; },
    get_dynamicLayout: function() { return this._dynamicLayout; },
    set_dynamicLayout: function(a) { this._dynamicLayout = a; },
    get_associatedUpdatePanelId: function() { return this._associatedUpdatePanelId; },
    set_associatedUpdatePanelId: function(a) { this._associatedUpdatePanelId = a; },
    get_role: function() { return "status"; },
