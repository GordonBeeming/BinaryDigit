<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="Binary_Digit_Blog.Account.Manage" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section id="externalUserAccountUsage">
        <h3>Use your account</h3>
        <p>You can use the ID <strong><%= User.Identity.GetUserId() %></strong> outside of this site with compatible applications to post information to this site in any area that is configured for your access.</p>
